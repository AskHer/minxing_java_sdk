		...
		public String getArticleBody(){
			...
			for(int i=0, s=articles.size(); i<s; i++){
				...
				if("resource".equals(pt.getType())){
					...
					sb.append("\"resource_id\":\"").append(pt.getResourceId()).append("\"");
					if(pt.getTitle() != null && !pt.getTitle().trim().equals("")){
						sb.append(",");
						sb.append("\"title\":\"").append(pt.getTitle()).append("\"");
					}
					
					if(pt.getPicUrl() != null && !pt.getPicUrl().trim().equals("")){
						sb.append(",");
						sb.append("\"pic_url\":\"").append(pt.getPicUrl()).append("\"");
					}
					
					if(pt.getDescription() != null && !pt.getDescription().trim().equals("")){
						sb.append(",");
						sb.append("\"description\":\"").append(pt.getDescription()).append("\"");
					}
					
				} else {
					sb.append("\"title\":").append("\"").append(pt.getTitle()).append("\"").append(",");
					sb.append("\"description\":").append("\"").append(pt.getDescription()).append("\"");
					if(pt.getPicUrl() != null){
						sb.append(",");
						sb.append("\"pic_url\":").append("\"").append(pt.getPicUrl()).append("\"");
					}
					if(pt.getApp_url() != null){
						sb.append(",");
						sb.append("\"app_url\":").append("\"").append(pt.getApp_url()).append("\"");
					}
					if(pt.getUrl() != null){
						sb.append(",");
